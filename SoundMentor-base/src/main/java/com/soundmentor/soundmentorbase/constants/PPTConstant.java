...
public class PPTConstant {
    ...
    public static final Integer PPT_VOICE_PICTURE_HEIGHT = 50;
    public static final Integer PPT_VOICE_PICTURE_X= 650;
    public static final Integer PPT_VOICE_PICTURE_Y= 450;
}
